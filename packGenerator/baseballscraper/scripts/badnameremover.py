...
def get_badnames():
    ...
    while(y<len(names)):
        ...
        #         with open("C:\\Users\\natha\\baseball-card-app\\baseballscraper\\CardImages\\CardsList.txt", "a") as writefile:
        ...
        #         if(y > 84):
        #             urllib.request.urlretrieve("https://www.tcdb.com" + frontimage, "C:\\Users\\natha\\baseball-card-app\\baseballscraper\\CardImages\\Fronts\\" + str(cardsgrabbed) + ".jpg")
        #             urllib.request.urlretrieve("https://www.tcdb.com" + backimage, "C:\\Users\\natha\\baseball-card-app\\baseballscraper\\CardImages\\Backs\\" + str(cardsgrabbed) + ".jpg")

        #             imgfront = Image.open("C:\\Users\\natha\\baseball-card-app\\baseballscraper\\CardImages\\Fronts\\" + str(cardsgrabbed) + ".jpg")
        #             imgback = Image.open("C:\\Users\\natha\\baseball-card-app\\baseballscraper\\CardImages\\Backs\\" + str(cardsgrabbed) + ".jpg")
                    
        #             if(imgback.width > imgback.height):
        #                 imgback.transpose(Image.ROTATE_90).save("C:\\Users\\natha\\baseball-card-app\\baseballscraper\\CardImages\\Backs\\" + str(cardsgrabbed) + ".jpg", subsampling =0, quality=100)
        #             if(imgfront.width > imgfront.height):    
        #                 imgfront.transpose(Image.ROTATE_90).save("C:\\Users\\natha\\baseball-card-app\\baseballscraper\\CardImages\\Fronts\\" + str(cardsgrabbed) + ".jpg", subsampling=0, quality=100)
        #         z+=1
        #         cardsgrabbed+=1
        #     x+=1
...
get_badnames()
x = 0
namefile = open("C:\\Users\\natha\\baseball-card-app\\baseballscraper\\baseballnamesfiltered.txt","w")
while (x<len(names)):
    namefile.write(names[x])
    namefile.write("\n")
    x+=1
