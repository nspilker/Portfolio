        ...
        while (x <= totalpages):
            ...
            while(z < numonpagetotal):
                ...
                if(imgback.width > imgback.height):
                    imgback.transpose(Image.ROTATE_90).save("C:\\Users\\natha\\baseball-card-app\\CardImages\\Backs\\" + str(cardsgrabbed) + ".jpg", subsampling =0, quality=100)
                if(imgfront.width > imgfront.height):    
                    imgfront.transpose(Image.ROTATE_90).save("C:\\Users\\natha\\baseball-card-app\\CardImages\\Fronts\\" + str(cardsgrabbed) + ".jpg", subsampling=0, quality=100)
                
                with open("C:\\Users\\natha\\baseball-card-app\\CardImages\\CardsListDynamic.txt", "a") as writefile:
